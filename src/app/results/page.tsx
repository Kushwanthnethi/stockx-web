                ...
                <div className="w-full space-y-8">
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-background border p-6 md:p-8">
                        <div className="relative z-10">
                            ...
                            <h1 className="text-3xl font-black tracking-tight mb-2 flex items-center gap-3 text-foreground pb-1">
                                <Megaphone className="w-8 h-8 text-blue-500" />
                                Result <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">Corner</span>
                            </h1>
