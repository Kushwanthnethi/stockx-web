        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader className="space-y-2 text-center">
                    ...
                    <DialogTitle className="text-2xl font-bold">Welcome to StockX</DialogTitle>
                    <DialogDescription>
                        Join the community of Indian investors.
                    </DialogDescription>
                </DialogHeader>
                ...
                <Tabs defaultValue="login" className="w-full">
                    ...
                    <TabsContent value="login" className="space-y-4 pt-4">
                        ...
                        <Button className="w-full font-bold" onClick={handleEmailLogin}>Login</Button>
                    </TabsContent>
                    ...
                    <TabsContent value="register" className="space-y-4 pt-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input id="first" placeholder="Max" value={firstName} onChange={e => setFirstName(e.target.value)} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="last">Last name</Label>
                                <Input id="last" placeholder="Robinson" value={lastName} onChange={e => setLastName(e.target.value)} />
                            </div>
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="pass-reg" type="password" value={password} onChange={e => setPassword(e.target.value)} />
                        </div>
                        {error && <p className="text-sm text-red-500">{error}</p>}
                        <Button className="w-full font-bold" onClick={handleRegister}>Create Account</Button>
                    </TabsContent>
                </Tabs>
                ...
                <p className="text-center text-xs text-muted-foreground pt-4 cursor-pointer hover:underline" onClick={() => handleOpenChange(false)}>
                    Continue as Guest
                </p>
            </DialogContent>
        </Dialog>
